...
#include "./dde-application-manager/toolGenerate/qdbusxml2cpp/org.desktopspec.ApplicationManager1.ApplicationAdaptor.h"
...
QString ApplicationAdaptor::startupWMClass() const
{
    // get the value of property StartupWMClass
    return qvariant_cast< QString >(parent()->property("StartupWMClass"));
}
...
QString ApplicationAdaptor::x_Deepin_CreateBy() const
{
    // get the value of property X_Deepin_CreateBy
