...
#include "./dde-application-manager/toolGenerate/qdbusxml2cpp/org.desktopspec.ApplicationManager1.Application.h"
QT_BEGIN_NAMESPACE
class QByteArray;
...
"      <annotation value=\"QStringMap\" name=\"org.qtproject.QtDBus.QtTypeName\"/>\n"
"    </property>\n"
"    <property access=\"read\" type=\"s\" name=\"StartupWMClass\">\n"
"      <annotation value=\"The meaning of this property's type is same as which in StartupWMClass.\" name=\"org.freedesktop.DBus.Description\"/>\n"
"      <annotation value=\"QStringMap\" name=\"org.qtproject.QtDBus.QtTypeName\"/>\n"
"    </property>\n"
"    <method name=\"Launch\">\n"
...
public: // PROPERTIES
    ...
    Q_PROPERTY(QString StartupWMClass READ startupWMClass)
    QString startupWMClass() const;

    Q_PROPERTY(bool Terminal READ terminal)
    bool terminal() const;

    Q_PROPERTY(QString X_Deepin_CreateBy READ x_Deepin_CreateBy)
    QString x_Deepin_CreateBy() const;
